...
class TreeAVLMapTest {
    ...
    @Test
    void whenAddNullKeyThenFalse() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        assertThat(tree.put(null, "65")).isFalse();
        assertThat(tree.keySet()).isEmpty();
    }

    @Test
    void whenAddNullValueThenTrue() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        tree.put(1, "11");
        tree.put(2, "22");
        tree.put(3, "33");
        tree.put(4, null);
        assertThat(tree.values()).hasSize(4)
                .containsExactly("11", "22", "33", null);
        assertThat(tree.get(4)).isNull();
    }

    @Test
    void whenTreeContainsKeyThenTrue() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        tree.put(1, "11");
        tree.put(2, "22");
        tree.put(3, "33");
        tree.put(4, "44");
        tree.put(5, "55");
        assertThat(tree.containsKey(4)).isTrue();
    }

    @Test
    void whenTreeContainsKeyThenFalse() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        tree.put(1, "11");
        tree.put(2, "22");
        tree.put(3, "33");
        tree.put(4, "44");
        tree.put(5, "55");
        assertThat(tree.containsKey(7)).isFalse();
    }

    @Test
    void whenTreeContainsValueThenTrue() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        tree.put(1, "11");
        tree.put(2, "22");
        tree.put(3, "33");
        tree.put(4, "44");
        tree.put(5, "55");
        assertThat(tree.containsValue("44")).isTrue();
    }

    @Test
    void whenTreeContainsValueThenFalse() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        tree.put(1, "11");
        tree.put(2, "22");
        tree.put(3, "33");
        tree.put(4, "44");
        tree.put(5, "55");
        assertThat(tree.containsValue("00")).isFalse();
    }
