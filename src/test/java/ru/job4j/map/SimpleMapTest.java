...
class SimpleMapTest {
    ...
    void whenPutDuplicates() {
        assertThat(map.put(2, "Two")).isFalse();
        assertThat(map.put(5, "Five")).isTrue();
        assertThat(map.put(null, "Nemo")).isTrue();
        assertThat(map).hasSize(6).contains(null, 1, 2, 3, 4, 5);
        assertThat(map.put(5, "5")).isFalse();
        assertThat(map.put(null, "N/A")).isFalse();
        assertThat(map).hasSize(6).contains(null, 1, 2, 3, 4, 5);
    }

    @Test
    void whenCheckExpand() {
        map.put(0, "0");
        map.put(5, "5");
        map.put(7, "7");
        assertThat(map).hasSize(7);
        assertThat(map.put(10, "Ten")).isTrue();
        assertThat(map.put(16, "16")).isFalse();
        assertThat(map).hasSize(8).contains(0, 1, 2, 3, 4, 5, 7, 10);
    }
    ...
    @Test
    void whenCheckIteratorOnEmptyMap() {
    ...
    @Test
    void whenCheckIteratorOnNullAndModification() {
        map.put(null, "Nemo");
        Iterator<Integer> it = map.iterator();
        assertThat(it.hasNext()).isTrue();
